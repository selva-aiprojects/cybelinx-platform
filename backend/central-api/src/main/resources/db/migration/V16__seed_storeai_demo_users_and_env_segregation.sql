...
SELECT '00000000-0000-0000-0000-000000000i10', (SELECT id FROM public.users WHERE email = 'storeai.admin@cybelinx.com'), 'supabase', 'sub-storeai-admin', 'storeai.admin@cybelinx.com', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
...
INSERT INTO public.user_identities (id, user_id, identity_provider, external_subject, email, is_primary, linked_at, created_at, updated_at)
SELECT '00000000-0000-0000-0000-000000000i11', (SELECT id FROM public.users WHERE email = 'demo.nike@cybelinx.com'), 'supabase', 'sub-demo-nike', 'demo.nike@cybelinx.com', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
WHERE NOT EXISTS (SELECT 1 FROM public.user_identities WHERE identity_provider = 'supabase' AND email = 'demo.nike@cybelinx.com');

INSERT INTO public.user_identities (id, user_id, identity_provider, external_subject, email, is_primary, linked_at, created_at, updated_at)
SELECT '00000000-0000-0000-0000-000000000i12', (SELECT id FROM public.users WHERE email = 'demo.adidas@cybelinx.com'), 'supabase', 'sub-demo-adidas', 'demo.adidas@cybelinx.com', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
...
SELECT '00000000-0000-0000-0000-000000000t11', 'STOREAI_NIKE_01', 'Nike Flagship Store', 'ACTIVE', (SELECT id FROM public.regions WHERE region_code = 'eu-west-1'), 'IE', 'UTC', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
WHERE NOT EXISTS (SELECT 1 FROM public.tenants WHERE tenant_code = 'STOREAI_NIKE_01');

INSERT INTO public.tenants (id, tenant_code, name, status, region_id, country, timezone, created_at, updated_at)
SELECT '00000000-0000-0000-0000-000000000t12', 'STOREAI_ADIDAS_01', 'Adidas Sportswear Store', 'ACTIVE', (SELECT id FROM public.regions WHERE region_code = 'eu-west-1'), 'IE', 'UTC', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
WHERE NOT EXISTS (SELECT 1 FROM public.tenants WHERE tenant_code = 'STOREAI_ADIDAS_01');

INSERT INTO public.tenants (id, tenant_code, name, status, region_id, country, timezone, created_at, updated_at)
SELECT '00000000-0000-0000-0000-000000000t13', 'STORE_PUMA_01', 'Puma Retail Store', 'ACTIVE', (SELECT id FROM public.regions WHERE region_code = 'eu-west-1'), 'IE', 'UTC', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
...
SELECT '00000000-0000-0000-0000-000000000m11', t.id, u.id, 'ACTIVE', u.id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
...
INSERT INTO public.tenant_memberships (id, tenant_id, user_id, status, invited_by_id, invited_at, joined_at, created_at, updated_at)
SELECT '00000000-0000-0000-0000-000000000m12', t.id, u.id, 'ACTIVE', u.id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM public.tenants t, public.users u
...
INSERT INTO public.tenant_resources (id, version, tenant_id, product_id, resource_type_id, isolation_mode, environment, status, provisioning_state, connection_config, created_at, updated_at)
SELECT 
    '00000000-0000-0000-0000-000000000r11',
    0,
    ...
    'ACTIVE',
    'SUCCEEDED',
    '{"schemaName":"tenant_demo_storeai_nike_db"}'::jsonb,
    CURRENT_TIMESTAMP,
    CURRENT_TIMESTAMP
WHERE NOT EXISTS (
...
INSERT INTO public.tenant_resources (id, version, tenant_id, product_id, resource_type_id, isolation_mode, environment, status, provisioning_state, connection_config, created_at, updated_at)
SELECT 
    '00000000-0000-0000-0000-000000000r12',
    0,
    ...
    'ACTIVE',
    'SUCCEEDED',
    '{"schemaName":"tenant_demo_storeai_adidas_db"}'::jsonb,
    CURRENT_TIMESTAMP,
    CURRENT_TIMESTAMP
WHERE NOT EXISTS (
    SELECT 1 FROM public.tenant_resources 
...
INSERT INTO public.tenant_resources (id, version, tenant_id, product_id, resource_type_id, isolation_mode, environment, status, provisioning_state, connection_config, created_at, updated_at)
SELECT 
    '00000000-0000-0000-0000-000000000r21',
    0,
    (SELECT id FROM public.tenants WHERE tenant_code = 'STOREAI_NIKE_01'),
    (SELECT id FROM public.products WHERE product_code = 'STOREAI'),
    (SELECT id FROM public.resource_catalog WHERE resource_type_code = 'POSTGRES_SCHEMA'),
    ...
    'ACTIVE',
    'SUCCEEDED',
    '{"schemaName":"tenant_prod_storeai_nike_db"}'::jsonb,
    CURRENT_TIMESTAMP,
    CURRENT_TIMESTAMP
WHERE NOT EXISTS (
    SELECT 1 FROM public.tenant_resources 
...
INSERT INTO public.tenant_resources (id, version, tenant_id, product_id, resource_type_id, isolation_mode, environment, status, provisioning_state, connection_config, created_at, updated_at)
SELECT 
    '00000000-0000-0000-0000-000000000r22',
    0,
    (SELECT id FROM public.tenants WHERE tenant_code = 'STOREAI_ADIDAS_01'),
    (SELECT id FROM public.products WHERE product_code = 'STOREAI'),
    (SELECT id FROM public.resource_catalog WHERE resource_type_code = 'POSTGRES_SCHEMA'),
    ...
    'ACTIVE',
    'SUCCEEDED',
    '{"schemaName":"tenant_prod_storeai_adidas_db"}'::jsonb,
    CURRENT_TIMESTAMP,
    CURRENT_TIMESTAMP
WHERE NOT EXISTS (
    SELECT 1 FROM public.tenant_resources 
